// Interne Produkt-Übersicht — nur für Vertrieb / Admin sichtbar.
// URL: /produkte (Route-Group `(intern)` beeinflusst die URL nicht).
// Vor der Single-Domain-Migration lag dieser Inhalt unter `/`. Seit Phase 2
// rendert `/` die Sterbegeld24Plus-Hauptseite — diese Übersicht ist nur noch
// über direkten Aufruf von `/produkte` erreichbar (nicht aus Footer-Nav).
...
export const metadata: Metadata = {
  title: 'LeadMonster — Produktübersicht (intern)',
  description: 'Interne Übersicht aller Versicherungs-Microsites',
      ...
      <div className="bg-[#1a3252] text-white">
        <div className="max-w-[1200px] mx-auto px-6 py-14">
          ...
          <p className="text-white/60 text-sm">
            Alle Microsites und Landingpages auf einen Blick (intern)
          </p>
        </div>
      </div>
